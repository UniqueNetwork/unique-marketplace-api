...
export class UpdatedSearchIndex1654004616562 implements MigrationInterface {
    name = 'UpdatedSearchIndex1654004616562'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        for (const item of await queryRunner.query(
          ...
          if (item.collection_id !== null && item.token_id !== null) {
            ...
            .where('collection_id = :collection_id and token_id = :token_id', 
            { collection_id: item.collection_id, token_id: item.token_id })
            .execute();
          }
        }
    }
